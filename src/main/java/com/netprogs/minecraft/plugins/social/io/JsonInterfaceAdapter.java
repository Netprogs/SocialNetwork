...
/**
 * Generic GSON serialize/deserialize solution that works for all cases where only interface is known statically.
 * Credit goes to: http://stackoverflow.com/a/9550086
 * @param <T>
 */
