...
public class PriestSettings extends GroupSettings {

    // the time required to pass before you can divorce
    private int honeymoonPeriod;

    public int getHoneymoonPeriod() {
        return honeymoonPeriod;
    }

    public void setHoneymoonPeriod(int honeymoonPeriod) {
        this.honeymoonPeriod = honeymoonPeriod;
    }
}
